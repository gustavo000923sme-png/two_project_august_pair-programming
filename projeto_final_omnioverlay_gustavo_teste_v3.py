"""
===============================================================================
PROJETO: OmniOverlay - Premium Theme Engine & Dynamic Shortcut Manager
===============================================================================
"""
...
# Tuplas globais de cores para garantir compatibilidade nos dois modos: ("CLARO", "ESCURO")
...
class DashboardFrame(ctk.CTkFrame):
    ...
    def montar_aba_hub(self):
        ...
        # PAINEL DE CRIAÇÃO E ADIÇÃO DINÂMICA
...
class OmniOverlay(ctk.CTk):
    ...
    def alternar_tema_global(self):
        """Alterna o tema e redesenha a tela para aplicar a nova cor das letras."""
        ...
        # Recria os componentes da tela para forçar atualização das fontes e cores
